...
const NUMBER_ITEMS: {
  ...
  { glyph: "0", label: "Số không", val: 0, ref: "0️⃣" },
  { glyph: "1", label: "Số một", val: 1, ref: "1️⃣" },
  { glyph: "2", label: "Số hai", val: 2, ref: "2️⃣" },
  { glyph: "3", label: "Số ba", val: 3, ref: "3️⃣" },
  { glyph: "4", label: "Số bốn", val: 4, ref: "4️⃣" },
  { glyph: "5", label: "Số năm", val: 5, ref: "5️⃣" },
  { glyph: "6", label: "Số sáu", val: 6, ref: "6️⃣" },
  { glyph: "7", label: "Số bảy", val: 7, ref: "7️⃣" },
  { glyph: "8", label: "Số tám", val: 8, ref: "8️⃣" },
  { glyph: "9", label: "Số chín", val: 9, ref: "9️⃣" },
  { glyph: "10", label: "Số mười", val: 10, ref: "🔟" },
  { glyph: "11", label: "Số mười một", val: 11, ref: "1️⃣" },
  { glyph: "12", label: "Số mười hai", val: 12, ref: "2️⃣" },
  { glyph: "13", label: "Số mười ba", val: 13, ref: "3️⃣" },
  { glyph: "14", label: "Số mười bốn", val: 14, ref: "4️⃣" },
  { glyph: "15", label: "Số mười lăm", val: 15, ref: "5️⃣" },
  { glyph: "16", label: "Số mười sáu", val: 16, ref: "6️⃣" },
  { glyph: "17", label: "Số mười bảy", val: 17, ref: "7️⃣" },
  { glyph: "18", label: "Số mười tám", val: 18, ref: "8️⃣" },
  { glyph: "19", label: "Số mười chín", val: 19, ref: "9️⃣" },
  { glyph: "20", label: "Số hai mươi", val: 20, ref: "2️⃣" },
];
...
const VIETNAMESE_HOUSEHOLD_ITEMS: {
  ...
  { id: "watermelon", label: "quả dưa hấu", ref: "🍉", cat: "hoa quả" },
