...
export async function loadGameSession(templateCode: string): Promise<new (...args: any[]) => GameSession> {
  switch (templateCode) {
    ...
    case "GT-029": {
      const mod = await import("#src/templates/GT-029/session");
      return mod.GT029Session;
    }
    case "GT-030": {
      const mod = await import("#src/templates/GT-030/session");
      return mod.GT030Session;
    }
    case "GT-031": {
      const mod = await import("#src/templates/GT-031/session");
      return mod.GT031Session;
    }
    case "GT-032": {
      const mod = await import("#src/templates/GT-032/session");
      return mod.GT032Session;
    }
    case "GT-033": {
      const mod = await import("#src/templates/GT-033/session");
      return mod.GT033Session;
    }
    case "GT-034": {
      const mod = await import("#src/templates/GT-034/session");
      return mod.GT034Session;
    }
    case "GT-035": {
      const mod = await import("#src/templates/GT-035/session");
...
export function createGameSessionSync(templateCode: string, cfg: EngineConfig): GameSession {
  switch (templateCode) {
    ...
    case "GT-029":
      return Reflect.construct(GT029Session, [cfg.content_pack, cfg.difficulty_params]);
    case "GT-030":
      return Reflect.construct(GT030Session, [cfg.content_pack, cfg.difficulty_params]);
    case "GT-031":
      return Reflect.construct(GT031Session, [cfg.content_pack, cfg.difficulty_params]);
    case "GT-032":
      return Reflect.construct(GT032Session, [cfg.content_pack, cfg.difficulty_params]);
    case "GT-033":
      return Reflect.construct(GT033Session, [cfg.content_pack, cfg.difficulty_params]);
    case "GT-034":
      return Reflect.construct(GT034Session, [cfg.content_pack, cfg.difficulty_params]);
    case "GT-035":
      return Reflect.construct(GT035Session, [cfg.content_pack, cfg.difficulty_params]);
    case "GT-036":
      return Reflect.construct(GT036Session, [cfg.content_pack, cfg.difficulty_params]);
    default:
      throw new Error(`TEMPLATE_NOT_SUPPORTED: ${templateCode}`);
  }
}
