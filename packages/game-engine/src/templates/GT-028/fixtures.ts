...
export const GT028_FIXTURES: {
  ...
  // Fixture 3: Đếm nhảy cóc 10 (bước 10, chạm 5 lần để được 50)
  {
    content: {
      ...
      target_total: 50,
      items: [
        { item_id: "flower_1", asset: { kind: "emoji", ref: "🌻" } },
        { item_id: "flower_2", asset: { kind: "emoji", ref: "🌻" } },
        { item_id: "flower_3", asset: { kind: "emoji", ref: "🌻" } },
        { item_id: "flower_4", asset: { kind: "emoji", ref: "🌻" } },
        { item_id: "flower_5", asset: { kind: "emoji", ref: "🌻" } },
        { item_id: "flower_6", asset: { kind: "emoji", ref: "🌻" } },
        { item_id: "flower_7", asset: { kind: "emoji", ref: "🌻" } },
        { item_id: "flower_8", asset: { kind: "emoji", ref: "🌻" } },
      ],
    },
    difficulty: {
      step: 10,
