...
describe("Feature: Hành vi kéo thả (drop) và fallback chạm-chạm — tha.feature", () => {
  ...
  describe("Scenario Outline: Thả ngoài mọi đích thì không commit và vật về chỗ cũ (Examples: GT-003, GT-004, GT-005)", () => {
  ...
  describe("Scenario Outline: Fallback chạm-chạm (tap-tap fallback) (Examples: GT-003, GT-004, GT-005)", () => {
