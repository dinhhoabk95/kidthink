...
> = {
  ...
  intro_recall_answered: new Set([
    "item_id",
    "step_id",
    "target_asset_id",
    "answer_correct",
  ]),
  intro_step_started: new Set([
    "step_id",
    "action",
    "target_asset_id",
    "asset_kind",
  ]),
  intro_step_answered: new Set([
    "step_id",
    "action",
    "answer_correct",
    "miss_count",
  ...
  intro_step_deferred: new Set(["step_id", "reason"]),
  intro_segment_started: new Set([
    "segment_id",
    "segment_index",
    "asset_count",
    "is_review",
  ]),
  intro_segment_completed: new Set([
    "segment_id",
    "segment_index",
    "miss_count",
  ]),
  intro_echo_started: new Set(["step_id", "target_asset_id", "tts_used"]),
  intro_echo_completed: new Set(["step_id", "target_asset_id", "replay_count"]),
  tts_unavailable: new Set(["prompt_id", "reason", "lang", "asset_id"]),
