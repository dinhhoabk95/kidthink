...
export const ALL_PROJECTIONS: Record<string, Projection> = {
  "GT-000": projectGT000,
  "GT-001": projectGT001,
  "GT-002": projectGT002,
  "GT-003": projectGT003,
...
export function getProjection(templateCode: string): Projection | undefined {
  return ALL_PROJECTIONS[templateCode];
}
