...
export const C4_SEED_ACTIVITIES: ActivitySeed[] = [
  {
    ...
    header: {
      ...
      materials_vi: "Bàn học, bàn tay của bé",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Quả cam, mẩu giấy vụn",
      estimated_minutes: 8,
      access_tier: "free",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Tranh ảnh sinh hoạt gia đình",
      estimated_minutes: 10,
      access_tier: "login",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Bình nhựa, cốc nhựa, nước sạch",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Giấy trắng, bút sáp màu",
      estimated_minutes: 10,
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "4 chiếc bút chì hoặc bút sáp màu",
      estimated_minutes: 10,
      access_tier: "standard",
      skill_codes: ["C4.LEN.01"],
      learning_objective_codes: ["LO-C4.LEN.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Băng dính giấy dán sàn",
      estimated_minutes: 12,
      access_tier: "standard",
      skill_codes: ["C4.LEN.01"],
      learning_objective_codes: ["LO-C4.LEN.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Chậu cây mầm, que gỗ nhỏ, bút dạ",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "1 chai nước đầy, 1 quả bóng nhựa nhẹ",
      estimated_minutes: 6,
      access_tier: "premium",
      skill_codes: ["C4.WGT.01"],
      learning_objective_codes: ["LO-C4.WGT.01-01"],
