...
export const C1_SEED_ACTIVITIES: ActivitySeed[] = [
  {
    ...
    header: {
      ...
      materials_vi: "Cốc nhựa, hạt đậu hoặc sỏi sạch",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Đồ dùng trong phòng khách",
      estimated_minutes: 10,
      access_tier: "login",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Gấu bông, tranh vẽ nấm đơn giản",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Thìa ăn cơm gia đình",
      estimated_minutes: 5,
      access_tier: "free",
      skill_codes: ["C1.CNT.01"],
      learning_objective_codes: ["LO-C1.CNT.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Sổ ghi chép nhỏ, bút chì",
      estimated_minutes: 10,
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Nắp chai nhựa sạch",
      estimated_minutes: 8,
      access_tier: "standard",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Cà chua bi hoặc củ quả nhỏ trong bếp",
      estimated_minutes: 6,
      access_tier: "premium",
      skill_codes: ["C1.NREC.05"],
      learning_objective_codes: ["LO-C1.NREC.05-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Lá cây rụng sạch, túi vải",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Đất nặn bột mì an toàn",
      estimated_minutes: 15,
      access_tier: "standard",
