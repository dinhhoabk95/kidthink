...
export const C3_SEED_ACTIVITIES: ActivitySeed[] = [
  {
    ...
    header: {
      ...
      materials_vi: "Khối đồ chơi lego hoặc cúc áo to 2 màu",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Khoảng trống an toàn trong nhà",
      estimated_minutes: 8,
      access_tier: "free",
      skill_codes: ["C3.PAT.01"],
      learning_objective_codes: ["LO-C3.PAT.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Các đôi tất gia đình sạch",
      estimated_minutes: 10,
      access_tier: "login",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "3 quả táo, 1 chiếc thìa",
      estimated_minutes: 8,
      access_tier: "login",
      skill_codes: ["C3.SRT.01"],
      learning_objective_codes: ["LO-C3.SRT.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Hộp giấy nhỏ nhiều màu, thú bông",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "2 giỏ đựng đồ gia đình",
      estimated_minutes: 10,
      access_tier: "free",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Ống hút giấy cắt khúc, dây dù mềm",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Áo kẻ sọc hoặc vải có họa tiết",
      estimated_minutes: 8,
      access_tier: "standard",
      skill_codes: ["C3.PAT.01"],
      learning_objective_codes: ["LO-C3.PAT.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Sổ vẽ, hồ dán an toàn, lá cây khô",
      estimated_minutes: 15,
      access_tier: "premium",
      skill_codes: ["C3.SRT.02"],
      learning_objective_codes: ["LO-C3.SRT.02-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "3 chiếc thìa, 3 chiếc dĩa ăn",
      estimated_minutes: 6,
      access_tier: "premium",
      skill_codes: ["C3.PAT.02"],
      learning_objective_codes: ["LO-C3.PAT.02-01"],
