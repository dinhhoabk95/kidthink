...
export const C2_SEED_ACTIVITIES: ActivitySeed[] = [
  {
    ...
    header: {
      ...
      materials_vi: "Rổ nhựa, đồ vật gia đình (nắp hộp, đĩa nhựa, đồng hồ)",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Băng dính giấy dán sàn dễ bóc",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Bàn học, sách truyện thiếu nhi",
      estimated_minutes: 8,
      access_tier: "login",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Gấu bông nhỏ, hộp các tông",
      estimated_minutes: 10,
      access_tier: "free",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Bìa giấy màu cắt hình cơ bản",
      estimated_minutes: 12,
      access_tier: "login",
      skill_codes: ["C2.2D.01"],
      learning_objective_codes: ["LO-C2.2D.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Que tính nhựa hoặc que kem sạch",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Lon sữa rỗng sạch, hộp bánh",
      estimated_minutes: 10,
      access_tier: "standard",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Gối sofa êm, đĩa nhựa làm vô lăng",
      estimated_minutes: 10,
      access_tier: "standard",
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "Vỏ hộp các-tông sạch",
      estimated_minutes: 15,
      access_tier: "premium",
      skill_codes: ["C2.3D.01"],
      learning_objective_codes: ["LO-C2.3D.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      materials_vi: "2 thú bông nhỏ, 1 chiếc ghế",
      estimated_minutes: 5,
      access_tier: "premium",
      skill_codes: ["C2.POS.01"],
      learning_objective_codes: ["LO-C2.POS.01-01"],
