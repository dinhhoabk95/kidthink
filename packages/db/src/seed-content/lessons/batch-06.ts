...
export const LESSON_BATCH_06: LessonSeed[] = [
  {
    ...
    header: {
      ...
      activity_codes: ["ACT-0031", "ACT-0037"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C4.LEN.01"],
      learning_objective_codes: ["LO-C4.LEN.01-01"],
      activity_codes: ["ACT-0035", "ACT-0038"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C4.LEN.01"],
      learning_objective_codes: ["LO-C4.LEN.01-01"],
      activity_codes: ["ACT-0031", "ACT-0038"],
  ...
  },
  {
    ...
    header: {
      ...
      activity_codes: ["ACT-0039", "ACT-0037"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C4.LEN.01"],
      learning_objective_codes: ["LO-C4.LEN.01-01"],
      activity_codes: ["ACT-0038", "ACT-0031"],
