...
export const LESSON_BATCH_04: LessonSeed[] = [
  {
    kind: "lesson",
    header: {
      code: "LES-0019",
      ...
      activity_codes: ["ACT-0014", "ACT-0020"],
  ...
  },
  {
    ...
    header: {
      ...
      activity_codes: ["ACT-0018", "ACT-0014"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C2.POS.01"],
      learning_objective_codes: ["LO-C2.POS.01-01"],
      activity_codes: ["ACT-0020", "ACT-0014"],
  ...
  },
  {
    ...
    header: {
      ...
      activity_codes: ["ACT-0018", "ACT-0020"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C2.POS.02"],
      learning_objective_codes: ["LO-C2.POS.02-01"],
      activity_codes: ["ACT-0018", "ACT-0012"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C2.POS.01", "C2.POS.02"],
      learning_objective_codes: ["LO-C2.POS.01-01", "LO-C2.POS.02-01"],
      activity_codes: ["ACT-0014", "ACT-0018"],
