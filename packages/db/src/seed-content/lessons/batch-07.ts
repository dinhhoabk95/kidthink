...
export const LESSON_BATCH_07: LessonSeed[] = [
  {
    ...
    header: {
      ...
      access_tier: "free",
      skill_codes: ["C1.MEAS.03", "C1.MEAS.10"],
      learning_objective_codes: ["LO-C1.MEAS.03-01", "LO-C1.MEAS.10-01"],
  ...
  },
  {
    ...
    header: {
      ...
      access_tier: "login",
      skill_codes: ["C1.MEAS.10", "C1.CMP.04"],
      learning_objective_codes: ["LO-C1.MEAS.10-01", "LO-C1.CMP.04-01"],
  ...
  },
  {
    ...
    header: {
      ...
      access_tier: "premium",
      skill_codes: ["C1.MEAS.03", "C1.CMP.04"],
      learning_objective_codes: ["LO-C1.MEAS.03-01", "LO-C1.CMP.04-01"],
