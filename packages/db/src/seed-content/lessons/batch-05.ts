...
export const LESSON_BATCH_05: LessonSeed[] = [
  {
    kind: "lesson",
    header: {
      code: "LES-0025",
  ...
  },
  {
    ...
    header: {
      ...
      access_tier: "login",
      skill_codes: ["C1.PAT.02", "C3.SRT.02"],
      learning_objective_codes: ["LO-C1.PAT.02-01", "LO-C3.SRT.02-01"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C1.PAT.02", "C1.PAT.01"],
      learning_objective_codes: ["LO-C1.PAT.02-01", "LO-C1.PAT.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      access_tier: "standard",
      skill_codes: ["C3.SRT.02", "C1.PAT.02"],
      learning_objective_codes: ["LO-C3.SRT.02-01", "LO-C1.PAT.02-01"],
  ...
  },
  {
    ...
    header: {
      ...
      access_tier: "login",
      skill_codes: ["C1.PAT.01", "C1.PAT.02"],
      learning_objective_codes: ["LO-C1.PAT.01-01", "LO-C1.PAT.02-01"],
  ...
  },
  {
    ...
    header: {
      ...
      access_tier: "free",
      skill_codes: ["C1.PAT.01", "C3.SRT.01"],
      learning_objective_codes: ["LO-C1.PAT.01-01", "LO-C3.SRT.01-01"],
