...
export const LESSON_BATCH_10: LessonSeed[] = [
  {
    kind: "lesson",
    header: {
      code: "LES-0055",
      ...
      activity_codes: ["ACT-0051", "ACT-0052"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C6.VAL.01", "C6.SAV.01"],
      learning_objective_codes: ["LO-C6.VAL.01-01", "LO-C6.SAV.01-01"],
      activity_codes: ["ACT-0053", "ACT-0054"],
  ...
  },
  {
    ...
    header: {
      ...
      activity_codes: ["ACT-0055", "ACT-0056"],
  ...
  },
  {
    ...
    header: {
      ...
      learning_objective_codes: ["LO-C6.VAL.01-01", "LO-C6.EXC.01-01"],
      activity_codes: ["ACT-0057", "ACT-0058"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C6.VAL.01", "C6.SAV.01"],
      learning_objective_codes: ["LO-C6.VAL.01-01", "LO-C6.SAV.01-01"],
      activity_codes: ["ACT-0059", "ACT-0060"],
  ...
  },
  {
    ...
    header: {
      ...
      activity_codes: ["ACT-0051", "ACT-0060"],
