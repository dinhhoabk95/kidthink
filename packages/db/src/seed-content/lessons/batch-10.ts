...
export const LESSON_BATCH_10: LessonSeed[] = [
  {
    ...
    header: {
      ...
      access_tier: "free",
      skill_codes: ["C1.MEAS.14", "C6.PLN.01"],
      learning_objective_codes: ["LO-C1.MEAS.14-01", "LO-C6.PLN.01-01"],
  ...
  },
  {
    ...
    header: {
      ...
      skill_codes: ["C1.MEAS.14", "C1.MEAS.14"],
      learning_objective_codes: ["LO-C1.MEAS.14-01", "LO-C1.MEAS.14-01"],
  ...
  },
  {
    ...
    header: {
      ...
      access_tier: "free",
      skill_codes: ["C1.MEAS.14", "C6.PLN.01", "C1.MEAS.14"],
