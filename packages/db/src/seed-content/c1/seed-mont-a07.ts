...
export const SEED_MONT_A07: ContentSeed<unknown, unknown>[] = [
  // WB07-D1 Level 1 (Diff 2 - Login)
  {
    ...
    content_pack: {
      ...
      parts: [
        ...
        { id: "p2", value: 1, is_target: true, label: "?" },
      ],
      options: [
        { id: "opt-1", value: 1, is_correct: true },
        { id: "opt-2", value: 2, is_correct: false },
        { id: "opt-3", value: 3, is_correct: false },
      ],
      scaffolding: {
  ...
  // WB07-D1 Level 2 (Diff 3 - Standard)
  {
    header: {
    ...
    content_pack: {
      ...
      parts: [
        { id: "p1", value: 2, is_target: false, label: "2" },
        { id: "p2", value: 3, is_target: true, label: "?" },
      ],
      options: [
        { id: "opt-1", value: 1, is_correct: false },
