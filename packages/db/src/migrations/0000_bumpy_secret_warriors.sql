...
ALTER TABLE "curriculum_item_progress" ADD CONSTRAINT "curriculum_item_progress_enrollment_id_curriculum_enrollments_i" FOREIGN KEY ("enrollment_id") REFERENCES "public"."curriculum_enrollments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "curriculum_item_progress" ADD CONSTRAINT "curriculum_item_progress_curriculum_item_id_curriculum_items_id" FOREIGN KEY ("curriculum_item_id") REFERENCES "public"."curriculum_items"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "personal_curriculum_enrollments" ADD CONSTRAINT "personal_curriculum_enrollments_personal_curriculum_id_personal" FOREIGN KEY ("personal_curriculum_id") REFERENCES "public"."personal_curricula"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "personal_curriculum_item_progress" ADD CONSTRAINT "personal_curriculum_item_progress_enrollment_id_personal_curric" FOREIGN KEY ("enrollment_id") REFERENCES "public"."personal_curriculum_enrollments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "personal_curriculum_item_progress" ADD CONSTRAINT "personal_curriculum_item_progress_personal_curriculum_item_id_p" FOREIGN KEY ("personal_curriculum_item_id") REFERENCES "public"."personal_curriculum_items"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "personal_curriculum_items" ADD CONSTRAINT "personal_curriculum_items_personal_curriculum_id_personal_curri" FOREIGN KEY ("personal_curriculum_id") REFERENCES "public"."personal_curricula"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
