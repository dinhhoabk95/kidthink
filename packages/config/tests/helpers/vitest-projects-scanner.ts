...
export const PROJECT_ROOTS: readonly ProjectRoot[] = [
  ...
  { name: "@mindkid/audit", prefix: "packages/audit" },
  { name: "@mindkid/auth", prefix: "packages/auth" },
  { name: "@mindkid/cache", prefix: "packages/cache" },
  { name: "@mindkid/config", prefix: "packages/config" },
  { name: "@mindkid/content", prefix: "packages/content" },
  { name: "@mindkid/content-build", prefix: "packages/content-build" },
  { name: "@mindkid/db", prefix: "packages/db" },
  { name: "@mindkid/emoji", prefix: "packages/emoji" },
  { name: "@mindkid/errors", prefix: "packages/errors" },
  { name: "@mindkid/export", prefix: "packages/export" },
  ...
  { name: "@mindkid/play", prefix: "packages/play" },
