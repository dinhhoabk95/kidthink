...
export const C1_PROB_03_REP = getQuantityRep("rep_discrete_object");
...
export const C1_PROB_03_DATASET: SkillDataset = {
  ...
  ladder: [
    ...
    },
    {
      ...
      description: "Phân biệt chia đều với phương án nhiễu",
    },
    {
      rung: 4,
      dimension: "item_count",
      description: "Mở rộng phạm vi chia đều",
    },
    {
      rung: 5,
      dimension: "speed_scaffolding",
      description: "Thuần thục chia đều và tự làm một mình",
    },
  ],
  phrasing: {
