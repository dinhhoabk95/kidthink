  ...
  levels: [
    {
      ...
      rounds: 1,
      sequence_no: 1,
      skill_codes: ["C5.VOC.13"],
    },
    {
      code: "GL-C5-VOC-TAP-0046",
      template: "GT-001",
      band: "4-5",
      difficulty: 2,
      theme: "school",
