  ...
  levels: [
    {
      ...
      rounds: 1,
      sequence_no: 1,
      skill_codes: ["C5.VOC.15"],
    },
    {
      code: "GL-C5-VOC-TAP-0056",
      template: "GT-001",
      band: "5-6",
      difficulty: 2,
      theme: "school",
