  ...
  levels: [
    {
      ...
      rounds: 1,
      sequence_no: 1,
      skill_codes: ["C5.DGR.01"],
    },
    {
      code: "GL-C5-DGR-TAP-0001",
      template: "GT-001",
      band: "5-6",
      difficulty: 2,
      theme: "school",
