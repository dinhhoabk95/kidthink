  ...
  levels: [
    {
      ...
      rounds: 1,
      sequence_no: 1,
      skill_codes: ["C5.LET.04"],
    },
    {
      code: "GL-C5-LET-TAP-0016",
      template: "GT-001",
      band: "4-5",
      difficulty: 1,
      theme: "vehicle",
