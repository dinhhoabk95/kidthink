  ...
  levels: [
    {
      ...
      rounds: 1,
      sequence_no: 1,
      skill_codes: ["C5.ONS.03"],
    },
    {
      code: "GL-C5-ONS-TAP-0011",
      template: "GT-001",
      band: "5-6",
      difficulty: 3,
      theme: "school",
