  ...
  levels: [
    {
      ...
      rounds: 1,
      sequence_no: 1,
      skill_codes: ["C5.RIM.06"],
    },
    {
      code: "GL-C5-RIM-TAP-0026",
      template: "GT-001",
      band: "5-6",
      difficulty: 3,
      theme: "school",
