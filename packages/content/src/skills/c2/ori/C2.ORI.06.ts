...
export const C2_ORI_06_DATASET: SkillDataset = {
  ...
  ladder: [
    {
      rung: 1,
      dimension: "range",
      description: "Làm quen cơ bản với Sau",
    },
    {
      rung: 2,
      dimension: "range",
      description: "Nhận biết và chọn đúng Sau",
    },
    {
      rung: 3,
  ...
  phrasing: {
    ...
    narration_template: "Chúng mình cùng tìm hiểu về Sau nhé",
