...
Nơi User sửa những gì thuộc về **họ**, ❌ không phải về trẻ (đó là `child-profile-crud`).
...
| Đặt mật khẩu lần đầu | ❌ **Không** giết phiên khác — `BR-ACS-10` |
...
| `BR-ACS-07` | ❌ **NEVER thu thêm dữ liệu cá nhân** ở trang này | `BR-REG-08` |
...
| `BR-ACS-10` | Đặt mật khẩu **lần đầu** ❌ **không** tăng `refresh_token_version` | ❌ Không có mật khẩu cũ để mất kiểm soát. Đá người dùng ra khỏi mọi thiết bị vì họ vừa **tăng** bảo mật là phạt nhầm hướng |
| `BR-ACS-11` | Nhóm **Bảo mật** liệt kê SNS đã liên kết, nhưng ❌ **không** sở hữu luồng đó — [`social-account-linking.md`](./social-account-linking.md) | `CONVENTIONS` §2: contract bị copy sẽ drift |
...
| Nhóm | Nội dung |
|---|---|
| **Thông tin** | Tên hiển thị. ❌ Không tuổi, giới tính, số điện thoại |
...
| **Quyền riêng tư** | Link `consent-management` · xuất dữ liệu · xoá tài khoản |
