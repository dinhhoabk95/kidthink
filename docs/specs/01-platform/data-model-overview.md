...
| 2 | Retention của `audit_logs` — giữ vĩnh viễn hay archive sang S3 sau 2 năm? | **Đóng 2026-08-07 (T12)**: xem [`audit-log.md`](audit-log.md) §11 Q1 — chủ duy nhất là `audit-log` (nó `owns` hình dạng bản ghi audit). Trả lời ở đó, không ở đây | Vận hành | P1 | [`audit-log.md`](audit-log.md) §11 Q1 |
