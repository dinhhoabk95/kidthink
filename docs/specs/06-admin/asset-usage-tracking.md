...
```jsonc
{
  ...
  "used_by": [
    { "entity_type": "game_level", "code": "G-C1-CNT-007", "version": 3, "status": "published", "title_vi": "Đếm quả táo" },
...
`content_asset_refs (entity_type, entity_code, entity_version, asset_kind, asset_ref)` cập
nhật khi lưu nội dung.
