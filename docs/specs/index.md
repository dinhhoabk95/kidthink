...
| [package-catalog](./00-foundation/package-catalog.md) | P0 | 2 SKU MVP + 4 add-on ❌ chưa bán |
...
| [health-check](./01-platform/health-check.md) | P0 | ❌ Không 200 cứng |
...
| [pricing-page](./02-public/pricing-page.md) | P2 | ❌ Không khan hiếm giả |
...
| [play-session-lifecycle](./04-play/play-session-lifecycle.md) | P1 | ❌ Không complete hai lần |
...
| [child-profile-admin](./06-admin/child-profile-admin.md) | P2 | **❌ Không có trang liệt kê trẻ** |
...
| [content-review-queue](./06-admin/content-review-queue.md) | P2 | ❌ Không duyệt theo lô |
...
| [system-activity](./06-admin/system-activity.md) | P2 | ❌ Không xanh khi ❌ không biết |
...
| [ai-assistant](./07-addon/ai-assistant.md) | P4 | sau `ai-credit-ledger` |
| [semantic-search](./07-addon/semantic-search.md) | P4 | pgvector, schema + job + rerank riêng khỏi `ai-assistant` |
