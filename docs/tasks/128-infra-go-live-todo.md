...
- [ ] `Q128-1` — nhà cung cấp VPS và cấu hình máy.
- [ ] `Q128-2` — tên miền thật và ai giữ DNS.
- [ ] `Q128-3` — đích sao lưu ngoài máy: nhà cung cấp bucket và vùng.
- [ ] `Q128-4` — migration lùi được hay forward-only.
- [ ] Xác nhận Task #109 đã đóng WP109.1 tới WP109.8.

## WP128.1 — Chuẩn bị

**Cỡ:** S · trước khi chạm máy

- [ ] Ghi `/etc/mindkid/env/{web,admin,worker}.env` theo giá trị thật.
- [ ] Ghi `compose/datastore.env` theo giá trị thật.
- [ ] Ca nhị phân giả 20 phần tráo đổi — chạy trên máy có root.
- [ ] Đối chiếu `MK_RELOAD_ORDER=(worker web)` với tài liệu ở `pm2.sh:9` và `90-vps-deploy-todo.md`; sửa tài liệu trôi.
...
- [ ] Nếu forward-only: khẳng định bản cũ chạy được trên lược đồ mới.

## WP128.4 — Đóng đuôi và dọn

**Cỡ:** S

- [ ] Đánh dấu WP90.11 của `90-vps-deploy-todo.md` đã đóng.
- [ ] Tick 17 ô còn lại của `109-vps-golive-blockers-todo.md`.
...
- Nhà cung cấp VPS và cấu hình: ................
- Tên miền: ................
- Bucket sao lưu: ................
- Thời gian `init` / `provision` / `deploy` thật: ................
- Gián đoạn thật khi phát hành: ................
- Thời gian khôi phục: ................
- Thời gian và gián đoạn khi rollback: ................
