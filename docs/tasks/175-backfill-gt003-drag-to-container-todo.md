...
- [x] `D1-01` Đếm & Kéo vào Rổ — 10 level, phân loại theo **số lượng**, `C1.CNT.01`
- [x] `D1-04` Nhận diện Chữ số — 10 level, theo **chữ số**, `C1.NREC.02`
- [x] `D2-05` Phân loại Hình — 10 level, theo **hình dạng**, `C3.CLS.02` · `C2.GEO.04`
- [x] `D4-01` Phân nhóm theo Màu — 10 level, theo **màu**, `C3.CLS.01`
- [x] `D4-02` Phân nhóm theo Hình — 10 level, theo **hình**, `C3.CLS.02`
- [x] `D4-03` Phân nhóm theo Kích thước — 10 level, theo **kích thước**, `C3.CLS.03`
- [x] `D4-04` Phân nhóm Đa thuộc tính — 10 level, **hai thuộc tính cùng lúc**, `C3.CLS.06`
- [x] `D4-08` Phân loại Đời thực — 10 level, theo **công dụng**, `C3.CLS.04`
- [x] Kiểm chéo: 8 lô khác nhau ở **thuộc tính phân loại**, cấm — NEVER chỉ khác chủ đề
- [x] ≥4 chủ đề trên toàn engine — `engine_max_ratio` 0,5 với 80 level nghĩa là trần 40/chủ đề

## Đóng task

- [x] `check:legacy-v1`: 8 game type của task đều ≥10 level (28/60 đạt).
...
- [x] `pnpm check` xanh.
- [x] Cập nhật dòng `#175` ở [`168-…-todo.md`](168-v1-game-list-integration-todo.md).
