...
> ⚠️ **Competency yếu nhất: 1/60 game type.** Cần đầu tư audio tiếng Việt trước
...
|---|---|---|---|---|---|---|
| C5.LIS.01 | Nghe và chọn | 3 | 2 | — | `listen` `match` | 🟡 |
| C5.LIS.02 | Nghe và làm theo | 3 | 2 | C5.LIS.01 | `listen` `plan` | 🟡 |
...
| Code | Skill | Tuổi | Khó | Prerequisite | Thinking | Status |
|---|---|---|---|---|---|---|
| C5.VOC.01 | Từ vựng động vật | 3 | 1 | — | `match` `recall` | 🟡 |
| C5.VOC.02 | Từ vựng trái cây | 3 | 1 | — | `match` `recall` | 🟡 |
| C5.VOC.03 | Từ vựng nghề nghiệp | 4 | 3 | — | `match` `infer` | 🟡 |
| C5.VOC.04 | Từ vựng gia đình | 3 | 2 | — | `match` `recall` | 🟡 |
| C5.VOC.05 | Từ vựng phương tiện | 3 | 2 | — | `match` `recall` | 🟡 |
...
| C5.STO.02 | Sắp xếp tranh theo trình tự truyện | 4 | 3 | C3.SEQ.04 | `sequence` `infer` | 🟡 |
| C5.STO.03 | Chọn kết thúc hợp lý | 5 | 4 | C5.STO.02 | `predict` `infer` | 🟡 |
| C5.STO.04 | Nguyên nhân – kết quả trong truyện | 5 | 4 | C3.INF.03 | `infer` `deduce` | 🟡 |
...
| Code | Skill | Tuổi | Khó | Prerequisite | Thinking | Status |
|---|---|---|---|---|---|---|
| C5.QUE.01 | Trả lời "Ai?" | 3 | 2 | C5.LIS.01 | `listen` `infer` | 🟡 |
| C5.QUE.02 | Trả lời "Cái gì?" | 3 | 2 | C5.LIS.01 | `listen` `infer` | 🟡 |
| C5.QUE.03 | Trả lời "Ở đâu?" | 4 | 3 | C5.QUE.02 · C2.ORI.07 | `listen` `infer` | 🟡 |
| C5.QUE.04 | Trả lời "Khi nào?" | 5 | 4 | C5.QUE.02 · C1.MEAS.10 | `listen` `sequence` | 🟡 |
| C5.QUE.05 | Trả lời "Tại sao?" | 5 | 4 | C5.QUE.02 · C3.INF.03 | `listen` `deduce` | 🟡 |
...
| Vấn đề | Hệ quả |
|---|---|
| Toàn bộ C5 cần **audio tiếng Việt** — trẻ 3–6 không đọc được | Không có audio ⇒ không có C5. Chặn cứng. |
