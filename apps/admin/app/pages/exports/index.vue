<template>
  <div class="p-8 max-w-6xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div
        class="bg-white dark:bg-slate-800 rounded-3xl border-2 border-slate-200 dark:border-slate-700 p-6 flex flex-col justify-between space-y-4 hover:border-indigo-500 transition-all shadow-sm"
      ...
      >
        ...
        <button
          class="w-full py-2.5 px-4 rounded-2xl bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-600 hover:text-white font-bold text-xs transition-all flex items-center justify-center gap-1.5"
          type="button"
