      ...
      >
        <div class="space-y-1">
          <div class="flex items-center gap-3">
            ...
            <span
              class="px-2 py-0.5 rounded-full text-xs font-bold bg-indigo-100 text-indigo-800"
            >
          ...
          <div class="text-xs text-surface-500">
            ...
            <span class="ml-2 text-rose-600 font-medium" v-if="child.purge_at">
        ...
        <div>
          <button
            class="min-h-11 px-4 py-2 rounded-2xl border-2 border-amber-300 bg-amber-50 hover:bg-amber-100 text-amber-800 text-xs font-bold font-heading transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            type="button"
