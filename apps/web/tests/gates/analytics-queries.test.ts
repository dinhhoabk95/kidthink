...
import {
  runAnalyticsQueriesGate,
  scanReportingQueries,
...
describe("Cổng lint:analytics-queries trên repo thật (BR-TLM-01)", () => {
  it("không route báo cáo nào truy vấn telemetry_events trực tiếp", () => {
    expect(runAnalyticsQueriesGate()).toEqual([]);
  });
});
